...
riot.tag2('home_page_root', '<section-header title="HOME"></section-header> <section class="section"> <div class="container"> <h1 class="title">CDN</h1> <h2 class="subtitle"></h2> <div class="contents"> <p>https://yanqirenshi.github.io/D3.Yabane/dist/0.0.1/d3.yabane.js</p> </div> </div> </section>', '', '', function(opts) {
});
