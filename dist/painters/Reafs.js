...
var Reafs = /*#__PURE__*/function (_ArrowFeather) {
  _inherits(Reafs, _ArrowFeather);

  var _super = _createSuper(Reafs);

  function Reafs(rectum) {
    var _this;

    _classCallCheck(this, Reafs);
  ...
  _createClass(Reafs, [{
    ...
    value: function drawText(place, reafs) {
      ...
      var selections = place.selectAll("text.reaf_label").data(reafs, function (d) {
        return d.id();
      }); // remove
    ...
    key: "draw",
    value: function draw(reafs) {
      var rectum = this.rectum();
      var place = rectum.layer('foreground');

      _get(_getPrototypeOf(Reafs.prototype), "draw", this).call(this, place, reafs);
